...
namespace AppMvc.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Nome,Email,CPF,Endereco,Ativo")] Aluno aluno)
        {
        ...
        [Route("editar-aluno/{id:int}")]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Nome,Email,CPF,Endereco,Ativo")] Aluno aluno)
        {
            if (ModelState.IsValid)
            {
